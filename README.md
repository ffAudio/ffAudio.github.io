...
This is a fork of Dean Attali's [beautiful-jekyll-theme](https://github.com/daattali/beautiful-jekyll). Please move to his repository for more accurate information, since I am not a web professional.
And definitely consider supporting him:
...
**Beautiful Jekyll** is a ready-to-use template to help you create an awesome website quickly. Perfect for personal sites, blogs, or simple project websites.  [Check out a demo](https://deanattali.com/beautiful-jekyll) of what you'll get after just two minutes.  You can also look at [my personal website](https://deanattali.com) to see it in use.
